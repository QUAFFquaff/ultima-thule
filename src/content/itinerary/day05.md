...
icon: "⛰️"
tags: ["峡湾", "彩虹街", "黑沙滩", "蝙蝠山"]
learningRefs: ["tyr", "aurora"]
highlights: ["Seyðisfjörður 彩虹街", "Hvalnes 灯塔", "Hvalnes 海滩", "Vestrahorn 与维京村", "Höfn"]
risks: ["先向东折返 Seyðisfjörður，再向南到 Höfn，车程较长", "峡湾道路弯道、风和雾增加驾驶疲劳", "已订住宿不应因临时加点而晚到"]
backup: ["天气或时间不合适时跳过 Seyðisfjörður", "保留 Hvalnes、Vestrahorn 与 Höfn 主线"]
planNotes:
...
Seyðisfjörður 以彩色木屋和彩虹街知名；Hvalnes 与 Vestrahorn 则把东南海岸、黑沙和锯齿状山体串在一起。

## 路线重点

这一天的问题不是点位本身，而是先东行再折返南下。页面把这条争议直接放在待确认卡片中，避免以后忘记。
