...
icon: "🌆"
tags: ["灯塔", "黑沙滩", "市区", "还车"]
learningRefs: ["volcano", "aurora"]
highlights: ["Reykjanesviti", "Reykjanes Black Sand Beach", "Tjörnin", "Hallgrímskirkja 登顶", "Skólavörðustígur 彩虹街"]
risks: ["海岸风浪与火山封控需临行确认", "市区停车后步行更合适", "晚间还车必须预留加油和检查时间"]
backup: ["半岛受限时只逛市区", "体力不足时优先教堂、彩虹街和按时还车"]
planNotes:
...
最后完整一天把雷克雅内斯海岸与首都市区合并。Hallgrímskirkja 的塔楼是俯瞰彩色屋顶的经典视角，彩虹街连接教堂与市中心。

## 还车优先

景点顺序仍按 Excel 显示，但晚间还车是硬截止时间。任何海岸支线都不能挤占加油、检查车辆与前往机场酒店的时间。
